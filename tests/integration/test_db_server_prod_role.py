...
HISTOGRAMS = [
    {
        'bin_values': [9, 9, 15, 8, 10, 18, 18, 25, 26, 28, 36, 35, 36, 34, 42, 33, 28, 37,
...
class TestDBServerProdRole:
    ...
    def test_histo(db_rc: RestClient) -> None:
        ...
        for orignial_histo in histograms:
            ...
            post_body_1 = {'database': 'test_histograms',
                           'collection': 'TEST',
            ...
            post_body_2 = {'database': 'test_histograms',
                           'collection': 'TEST',
                           'histogram': orignial_histo}
            ...
            post_body_3 = {'database': 'test_histograms',
                           'collection': 'TEST',
    ...
    def test_file(db_rc: RestClient) -> None:
        ...
        post_body_4 = {'database': 'test_histograms',
                       'collection': collection_name,
                       'files': new_files,
                       'update': True}
